 ...
 * [br.com.watchup.core.data.domain.MidiaLogic] — não são escolhidos pelo
...
/**
 * Gêneros oferecidos no cadastro (seleção múltipla). Alinhados aos gêneros do TMDB
 * (pt-BR) para que a busca consiga pré-selecionar os chips diretamente.
 */
val GENEROS_DISPONIVEIS: List<String> = listOf(
    "Ação", "Ação e Aventura", "Animação", "Aventura", "Cinema TV", "Comédia", "Crime",
    "Documentário", "Drama", "Família", "Fantasia", "Faroeste", "Ficção científica",
    "Ficção científica e Fantasia", "Guerra", "Guerra e Política", "História", "Kids",
    "Mistério", "Música", "Notícias", "Novela", "Reality", "Romance", "Talk", "Terror",
    "Thriller",
)
